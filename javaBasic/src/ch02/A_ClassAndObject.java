...
class ExampleClass1 {
	...
	void method3 ( int arg1) {
		// void에서의 return은 강제로 메서드를 종료하기위해 사용 --> 반복문에서는 break! 같은 기능
		return;
	}
	// 매개변수 : X, 반환값 : X
	void method4 () {	
	...
	// 클래스와 같은 이름을 가지고 있고, 반환타입이 존재하지 않음 -> '무조건' 인스턴스을 반환하기 때문
	// 클래스명 ([매개변수,...]) {인스턴스가 생성될때 할 적업} 
...
public class A_ClassAndObject {
	...
	public static void main(String[] args) {
		...
		// 인스턴스.메서드();
		instance1.method1(1, 2); //-> 17줄로 복사되서 arg1, arg2로 감
		instance1.method2();
		instance1.method3(1);
		instance1.method4();
