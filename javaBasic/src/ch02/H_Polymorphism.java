...
public class H_Polymorphism {
	...
	public static void main(String[] args) {
		...
		FootballPlay football = new FootballPlayer1(); // ->이해하기
		
		// human2.position = ""; -> 바라보고 있지 않음
		...
		// System.out.println(hm.goal); -> Human만 보고 있음
		// hm.kick(); -> Human만 보고 있음
		
		FootballPlayer1 fpp = (FootballPlayer1) hm; // -> 강제로 시야를 넓힘 (강제형변환하고 같음)
...
//		
//		dev.position = "포지션";
//		System.out.println(dev.position);  --> 다형성 때문에 
