...
public class C_Operator {
	...
	public static void main(String[] args) {
		...
		// 나누기: /
		// 좌항에 우항을 나눈 결과를 반환
		// 정수 나누기 정수의 결과는 실수부가 버려짐 -> 정수부분만 표현되기 때문에 -> 데이터 손실
		intResult = a / b;
		...
		// 비교 연산 : 좌항과 우항을 비교하여 그 결과를 논리값으로 반환 --> 가장 많이 사용
		boolean booleanResult;
		
		// 같다, 다르다 연산 : 
		// == : 좌항과 우항이 같으면 true, 다르면 false
		// != : 좌항과 후항이 다르면 true, 같으면 false
		booleanResult = a == b;
		...
		// a:15, b:7
		booleanResult = (a < b) && (a > ++b); //--> &&뒤를 읽지 않음
		System.out.println(booleanResult);
